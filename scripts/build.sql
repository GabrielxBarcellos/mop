...
INSERT INTO  NC_SETOR (SETOR, CARGO,FUNCAO) VALUES('ATACADO','ASSISTENTE COMERCIAL','ASSISTENCIA'),
...
INSERT INTO NC_MOP(CAD) VALUES (1)
...
DROP TABLE NC_MOVIMENTACOES_DESLIGAMENTO
CREATE TABLE NC_MOVIMENTACOES_DESLIGAMENTO (
    FEITO BIT,
    ID INT PRIMARY KEY IDENTITY,
    MATRICULA INT,
    NOME VARCHAR(255),
    MES_ANO VARCHAR (10),
    SETOR_ANTIGO VARCHAR(255),
    CARGO_ANTIGO VARCHAR(255),
    FUNCAO_ANTIGO VARCHAR(255),
    JORNADA_ANTIGO VARCHAR(255),
    CC_ANTIGO VARCHAR(255),
    STATUS_ANTIGO VARCHAR(255),
    SETOR_NOVO VARCHAR(255),
    CARGO_NOVO VARCHAR(255),
    FUNCAO_NOVO VARCHAR(255),
    JORNADA_NOVO VARCHAR(255),
    CC_NOVO VARCHAR(255),
